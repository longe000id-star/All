...
\author{Copyright Oxford University Press 2025\\
...
\verb+\address{...}+&  \verb+\subsubsection{...}+&     \verb+\bibliography{...}+\\\hline
\verb+\corresp[]{...}+&   \verb+\paragraph{...}+& \verb+\begin{biography}{...}{...}\end{biography}+\\\hline
\verb+\received{...}{...}{...}+&   \verb+\begin{algorithm}...\end{algorithm}+&     \\\hline
\verb+\revised{...}{...}{...}+&    \verb+\begin{lstlisting}...\end{lstlisting}+&      \\\hline
\verb+\accepted{...}{...}{...}+&     \verb+\begin{table}...\end{table}+&      \\\hline
\verb+\abstract{...}+&    \verb+\begin{figure}...\end{figure}+&    \\\hline
\verb+\keywords{...}+&  \verb+\begin{enumerate}...\end{enumerate}+&      \\\hline
\verb+\boxedtext{...}{...}+&  \verb+\begin{unlist}...\end{unlist}+&    \\\hline
\verb+\editor{...}+&   \verb+\begin{itemize}...\end{itemize}+&  \\\hline
\verb+\maketitle+&      \verb+\begin{theorem}...\end{theorem}+&  \\\hline
&     \verb+\begin{proposition}...\end{proposition}+&    \\\hline
...
\subsection{Box Elements}

For box elements, use the below format: 

\begin{verbatim}
\begin{boxtext}[Box Title]...\end{boxtext}
\end{verbatim}
...
\begin{enumerate}
\item author-year citation style = \verb+\bibliographystyle{oup-abbrvnat}+
\item numbered citation style = \verb+\bibliographystyle{oup-plain}+
\end{enumerate}
...
\hline
 ...
 \hline
 02 &    17 November, 2025 & Version 1.2   &   \\
 \hline
\end{tabular}
